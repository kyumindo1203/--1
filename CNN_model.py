...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(int(524288/BS), BS)  #입력받을 텐서 크기(feature)
        self.fc2 = nn.Linear(BS, 5) #5개의 타입으로 결과 나옴 
    ...
    def forward(self, x):
        ...
        x = x.view(BS, -1) #완전연결층 입력 형식에 맞게 조정 (차원 한단계 낮춤 =>1D)
